...
st.set_page_config(page_title="📄 Documentizer", layout="wide")
st.title("📄 Documentizer")
...
st.markdown("<div style='text-align: center; margin-top: 20px;'>Project made by Shashank.D</div>", unsafe_allow_html=True)
